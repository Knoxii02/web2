...
db.serialize(() => {
    ...
    const products = [
        ...
        },
        {
            ...
            long_description: 'Dies ist Teil 4 des Werkes "Mathe durchdringen" und behandelt den Zahlenraum bis 1000. Es baut auf den vorangehenden Werken auf und richtet sich an GrundschullehrerInnen von 3. Klassen und an SonderschullehrerInne, die den Zahlenraum 1000 erarbeiten wollen, sowie an Lerntherapeuten, die mit rechenschwachen Kindern arbeiten. Auch dieses Buch eignet sich besonders für inklusive Klassen, da es ein eher kleinschrittiges Vorgehen für schwächere SchülerInnen und ein schnelleres Vorgehen für stärkere SchülerInnen ermöglicht und viel Differenzierungsmaterial enthält. Durch die neu entwickelten Cuipsi-Quader erweitern die SchülerInnen ihre bisher erworbenen Kenntnisse und können weiter alle Aufgaben handelnd lösen, wenn ihnen der abstrakte Umgang mit Zahlen schwer fällt. Auf der beiliegenden CD finden sich die farbigen Materialien zum Selbstausdrucken. Die Buchvorlage ist schwarz-weiß.',
            price: 39.90,
            image_folder: 'book_4/',
            category: 'Buch'
        },
        {
            ...
            long_description: 'Das Arbeitsheft zur Pränumerik beinhaltet alle Arbeitsblätter für die Schülerhand, die im Buch "Mit Cuipsi den Mengen auf der Spur" erläutert werden. Zusätzlich gibt es weitere Arbeitsblätter, die je nach Bedarf eingesetzt werden können. Daneben eignet es sich dafür, die Schüler im Umgang mit einem Heft anzuleiten. Auch hier haben die Autorinnen die Ringbuchform gewählt, damit die Schüler problemlos die Stäbe auf die Vorlagen legen können. Erleichtert wird dadurch auch das individuelle Voranschreiten des Lernstoffes. Die Lehrkraft behält zudem auf einfache Art und Weise den Überblick über den Stand der einzelnen Schüler. Da dieses Ringbuch als Wendebuch konzipiert ist, kann parallel die Schreibweise der Ziffern geübt werden. Der Umfang beträgt 71 Seiten.',
            price: 8.95,
        ...
        },
        {
            ...
            long_description: 'Das Arbeitsheft für den ZR -20 enthält alle nötigen Schritte, um den ZR - 20 fundiert aufzubauen. Das Arbeitsheft mit praktischer Spiralbindung ist für den differenzierenden Einsatz in der Grundschule geeignet und damit auch für den Einsatz in der Förderschule. Für den Einsatz in der Förderschule gibt es weitere Informationen bei den Autorinnen. Darüber hinaus enthält das Grundschul-Arbeitsheft auch Seiten mit Förderniveau, so dass leistungsstärkere Schüler hier einen Lernanzreiz finden. Durch den Einsatz des Arbeitsheftes ist ein individuelles Voranschreiten jedes einzelnen Schülers möglich. Staffelpreise bei Bestellung für eine ganze Schulklasse möglich. Der Umfang beträgt 161 Seiten.',
            price: 24.95,
        ...
        },
        {
            ...
            long_description: 'Die Cuispi-Platten aus Holz wurden neu entwickelt und erleichtern das operative Handeln im Zahlenraum bis 100. Sie wirken dem Zählen entgegen. Gemeinsam mit den Stäben ist eine schnelle und auf einen Blick erkennbare Zahldarstellung möglich. Ein Satz enthält 3x die 20er-Platte und je 2x die 30er-, 40er-, 50er-, 60er-, 70er-, 80er-, 90er-Platte und eine 100er-Platte, Die Cuipsi-Platten werden zusammen mit einer praktischen Aufbewahrungsbox geliefert. Bestellen Sie mindestens 8 Schülersätze, so gibt es als Bonus praktische Vorlagen dazu, mit denen das passende Tafelmaterial einfach selbst hergestellt werden kann.',
            price: 27.80,
        ...
        },
        {
            ...
            long_description: 'Das Cuipsi-Quader-Komplettpaket enthält  je zwei 200er-, 300er-, 400er- und 500er-Cuipsi-Quader und je einen 600er-, 700er-, 800er- und 900er-Cuipsi-Quader. Zusätzlich sind Vorlagen für das passende Tafelmaterial sowie Cuipsi-Quader-Bastelvorlagen für die Schülerhand enthalten. Die neu entwickelten Cuipsi-Quader werden als EInzelstücke angefertigt. Sie sind aus einem biologisch abbaubaren Kunststoff. Aufgrund der langen Herstellungsdauer ist die Lieferzeit entsprechend länger. Sie dienen der Lehrkraft als Anschauungsmittel im Zahlenraum bis 1000 und helfen bei der Erarbeitung und Sicherung des Stellenwerts gemeinsam mit den Cuisenaire-Stäben und den Cuipsi-Platten. Zusätzlich enthält dieses Paket Vorlagen für das Cuipsi-Quader Tafelmaterial. Dazu können sie vergrößert auf farbiges Tonpapier gedruckt, laminiert und mit einem Magnetstreifen versehen werden. So hat die Lehrkraft ein Anschauungsmaterial für die Tafel, um einzelne Rechenschritte zu erklären oder um mit einzelnen Schüler an der Tafel zu arbeiten. Des weiteren enthält es eine Bastelvorlage, mit der die Schüler sich selbst Cuipsi-Quader basteln können.',
            price: 69.95,
